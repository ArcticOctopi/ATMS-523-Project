...
## Workflow:
  ...
  Not surprisingly, Geopotential Height dominated for both predictands. However, I thought it was interesting that for Max Winds EOF 2 seemed to be the primary influencer while Central Pressure seemed to be more influenced by EOF1.
